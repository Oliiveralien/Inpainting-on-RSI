...
if __name__ == '__main__':
    ...
    whole_model_path = 'model_logs/202007182228_full_model_wcrect_sa_bn_256/epoch_1000_ckpt.pth.tar'
    nets = torch.load(whole_model_path)
    netG_state_dict, netD_state_dict = nets['netG_state_dict'], nets['netD_state_dict']
    netG.load_state_dict(netG_state_dict)
    netD.load_state_dict(netD_state_dict)
    flop, param = get_model_complexity_info(netG, (3,256,256), as_strings=True, print_per_layer_stat=False)
